...
\usepackage{cancel}
\usepackage{graphicx}
\usepackage[natbib=true,style=ieee,backref=true,maxcitenames=2,mincitenames=1]{biblatex}
...
\input{02_Preliminary} \newpage
\input{03_Diffusion_time-series}
\input{04_Discussion_conclusion_future}
